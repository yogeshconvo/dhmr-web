...
// //           {/* Top links */}
// //           <div className="flex flex-col flex-wrap gap-2 text-[13px] font-[500] font-helvetica text-white border-b-[3px] pb-4 border-b-white">
// //             {topLinks.map((link, index) => {
// //               const isExternal = link.to.startsWith("http");
...
//       <div className="flex justify-between items-center px-4 xl:px-6 py-3 pb-0 xl:ml-20 xl:mr-20 ml-0 mr-0 h-full">
//         {/* Logo */}
//         <Link to={"/"} className="flex items-center xl:w-[340px]">
//           <img src={logo} alt="Logo" className="xl:w-[200px] w-[200px] z-50" />
//         </Link>
...
//                     target="_blank"
//                     rel="noopener noreferrer"
//                     className={`pb-[2px] border-b-[5px] border-transparent hover:border-[#ff4f37]`}
//                     style={{
//                       textWrapMode: "nowrap",
//                     }}
//                   >
...
//                     rel="noopener noreferrer"
//                     onClick={() => setMobileMenuOpen(false)}
//                     className={`border-b-[1px] pb-2 [&:not(:last-child)]:border-b-ligh-gray block border-transparent hover:text-[#ff4f37]`}
//                   >
//                     {link.label}
//                   </a>
//                 );
  ...
  return (
    <div className="fixed w-full bg-white top-0 left-0 z-50 shadow-md h-[100px] xl:h-[100px]">
      ...
      >
        ...
        {/* Mobile Menu Content */}
        <div className="flex flex-col p-4 space-y-4 text-sm text-white font-oswald-medium font-light h-full overflow-y-auto">
          {/* Main nav links */}
          <div className="flex flex-col gap-2 space-y-2 font-oswald-medium font-medium text-[16px] border-b-[3px] pb-4 border-b-white">
            {navLinks.map((link) => (
              <Link
                key={link.to}
                to={link.to}
