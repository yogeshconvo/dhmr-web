...
const ResearchPage = () => {
  return (
    <div className="px-10 md:px-20 py-20 bg-white text-gray-700 font-oswald-medium">
      {/* Hero Section */}
      <section className="text-center mb-16">
        <h1 className="text-3xl md:text-4xl text-gray-500 leading-tight font-[500]">
          INNOVATING FOR IMPACT.
          <br />
          RESEARCHING FOR HUMANITY.
        </h1>
        <p className="mt-6 text-base md:text-[18px] font-light text-gray-600 max-w-4xl mx-auto">
      ...
      <section className="w-full flex flex-col items-center  px-4 py-5 relative">
        <div className="flex items-start justify-center gap-3">
          ...
          <p className="text-gray-700 text-lg sm:text-xl md:text-4xl max-w-5xl leading-relaxed font-[300] relative">
