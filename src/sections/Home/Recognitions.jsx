  ...
  return (
    <div className="md:py-12 px-3 sm:px-6 md:px-45 py-15  mx-auto overflow-hidden">
      ...
      <Slider {...settings}>
        ...
        <div className="bg-white px-4 mr-2 sm:px-6 2xl:px-8 py-4 sm:py-6 min-h-[400px] sm:min-h-[450px] 2xl:h-[520px] flex items-center font-sans">
          <div className="flex flex-col 2xl:flex-row flex-wrap justify-between items-stretch gap-4 sm:gap-6 2xl:gap-4 w-full font-sans">
            {/* NAAC Block - Mobile view will be flex row */}
            <div className="w-full flex flex-col 2xl:flex-row 2xl:w-1/4 text-center 2xl:text-left border-b 2xl:border-b-0 2xl:border-r-2 pb-4 2xl:pb-0 2xl:pr-6">
              <div className="flex flex-row 2xl:flex-col justify-between 2xl:justify-start items-center 2xl:items-start w-full 2xl:w-auto">
                <img
                  src={IndiaImg}
                  alt="NAAC Logo"
                  className="2xl:mx-0 w-24 sm:w-28 2xl:w-32 xl:w-36 h-auto"
                  loading="lazy"
                />
                <div className="2xl:mt-0 ml-4 2xl:ml-0 text-left 2xl:text-left">
                  <h3 className="mt-0 sm:mt-3">
                    <span className="text-[#E60019] font-bold text-2xl sm:text-3xl 2xl:text-4xl xl:text-5xl">
                      NAAC A++
                    </span>
                    <span className="block text-[#122E5E] text-2xl sm:text-3xl 2xl:text-4xl xl:text-5xl">
                      CGPA: 3.78
                    </span>
                  </h3>
                  <p className="text-sm sm:text-lg 2xl:text-xl xl:text-2xl text-gray-500 mt-1 2xl:block">
            ...
            {/* NIRF Rankings Block */}
            <div className="w-full 2xl:w-1/2 border-b 2xl:border-b-0 2xl:border-r-2 px-0 2xl:px-2 xl:px-4 pb-4 2xl:pb-0 flex flex-col justify-between">
              <div className="flex flex-col items-center 2xl:items-start">
                <img
                  src={GroupImage}
                  alt="NIRF Logo"
                  className="w-28 sm:w-32 2xl:w-36 xl:w-40 max-w-xs"
                  loading="lazy"
                />
                <div className="grid grid-cols-2 sm:grid-cols-4 2xl:flex 2xl:flex-wrap justify-center 2xl:justify-start pt-2 sm:pt-3 gap-2 sm:gap-1 w-full">
                  {[
                    ...
                    border-gray-300 flex-1 text-center 2xl:text-left min-w-0`}
                    >
                      <em className="text-4xl sm:text-3xl 2xl:text-4xl xl:text-6xl font-bold text-[#E60019] not-italic block">
                        {item.num}
                        <sup className="text-xs sm:text-sm font-bold mt-0 align-middle">
                          {item.suffix}
                        </sup>
                      </em>
                      <span className="block text-sm sm:text-sm 2xl:text-base xl:text-2xl text-[#707070] mt-1 leading-tight">
                        {item.label}
                      </span>
                    </div>
                  ))}
            ...
            <div className="w-full 2xl:w-1/5 text-center 2xl:text-left pt-4 2xl:pt-0 flex flex-col justify-between">
              <div className="flex flex-row 2xl:flex-col justify-between items-center 2xl:items-start">
                <em className="text-5xl text-start  sm:text-4xl 2xl:text-5xl xl:text-6xl text-[#E60019] leading-tight font-[500] not-italic block">
                  1001-
                  <br className="hidden 2xl:block" />
                  1200
                </em>
                <p className="text-3xl text-start sm:text-3xl 2xl:text-3xl xl:text-4xl text-[#707070] mt-1 2xl:mt-1 font-sans leading-tight">
                  Times Higher <br className="hidden 2xl:block" /> Education{" "}
                  <br className="hidden 2xl:block" /> 2025
                </p>
              </div>
            </div>
          </div>
